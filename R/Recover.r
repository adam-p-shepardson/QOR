...
#' @param FIPS_code State FIPS code in two-digit character form (e.g., '09', '10',  etc...) to filter NCES school district shapefiles (default: NULL, which means no filtering by state). NOTE: If FIPS_code indicates a New England state, the Recover function will automatically pad short strings with extra left zeros (e.g., 1201 --> 01201)
...
recover <- function(units = NULL, polygons = NULL, zipcodes = NULL, unit_id = "unit_id", unit_zip = "postalcode", 
  ...
  rm(statedistances) # free up RAM immediately
